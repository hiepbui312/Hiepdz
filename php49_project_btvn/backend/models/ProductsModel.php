	...
	trait ProductsModel{
		...
		public function modelUpdate($id){
			...
			if($_FILES["photo1"]["name"] != ""){
				...
				//lay mot ban ghi
				$oldPhoto = $queryOldPhoto->fetch();
				if($oldPhoto->photo1 != "" && file_exists("../assets/upload/img/".$oldPhoto->photo1))
					unlink("../assets/upload/img/".$oldPhoto->photo1);
				//---
				$photo1 = time()."_".$_FILES["photo1"]["name"];
				//upload anh
				move_uploaded_file($_FILES["photo1"]["tmp_name"], "../assets/upload/img/$photo1");
			...
			if($_FILES["photo2"]["name"] != ""){
				...
				//lay mot ban ghi
				$oldPhoto = $queryOldPhoto->fetch();
				if($oldPhoto->photo2 != "" && file_exists("../assets/upload/img/".$oldPhoto->photo2))
					unlink("../assets/upload/img/".$oldPhoto->photo2);
				//---
				$photo2 = time()."_".$_FILES["photo2"]["name"];
				//upload anh
				move_uploaded_file($_FILES["photo2"]["tmp_name"], "../assets/upload/img/$photo2");
			...
			if($_FILES["photo3"]["name"] != ""){
				...
				//lay mot ban ghi
				$oldPhoto = $queryOldPhoto->fetch();
				if($oldPhoto->photo3 != "" && file_exists("../assets/upload/img/".$oldPhoto->photo3))
					unlink("../assets/upload/img/".$oldPhoto->photo3);
				//---
				$photo3 = time()."_".$_FILES["photo3"]["name"];
				//upload anh
				move_uploaded_file($_FILES["photo3"]["tmp_name"], "../assets/upload/img/$photo3");
			...
			if($_FILES["photo4"]["name"] != ""){
				...
				//lay mot ban ghi
				$oldPhoto = $queryOldPhoto->fetch();
				if($oldPhoto->photo4 != "" && file_exists("../assets/upload/img/".$oldPhoto->photo4))
					unlink("../assets/upload/img/".$oldPhoto->photo4);
				//---
				$photo4 = time()."_".$_FILES["photo4"]["name"];
				//upload anh
				move_uploaded_file($_FILES["photo4"]["tmp_name"], "../assets/upload/img/$photo4");
			...
			if($_FILES["photo5"]["name"] != ""){
				...
				//lay mot ban ghi
				$oldPhoto = $queryOldPhoto->fetch();
				if($oldPhoto->photo5 != "" && file_exists("../assets/upload/img/".$oldPhoto->photo5))
					unlink("../assets/upload/img/".$oldPhoto->photo5);
				//---
				$photo5 = time()."_".$_FILES["photo5"]["name"];
				//upload anh
				move_uploaded_file($_FILES["photo5"]["tmp_name"], "../assets/upload/img/$photo5");
