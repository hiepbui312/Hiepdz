    ...
    <div class="panel panel-primary">
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo $action; ?>">
            ...
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2"></div>
                <div class="col-md-10">
                    <?php if(isset($record->photo1) && $record->photo1 != "" && file_exists("../assets/upload/img/".$record->photo1)): ?>
                        <img src="../assets/upload/img/<?php echo $record->photo1; ?>" style="width:100px;">
                    <?php endif; ?>
                </div>
            </div>
            <!-- end rows -->
            ...
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2"></div>
                <div class="col-md-10">
                    <?php if(isset($record->photo2) && $record->photo2 != "" && file_exists("../assets/upload/img/".$record->photo2)): ?>
                        <img src="../assets/upload/img/<?php echo $record->photo2; ?>" style="width:100px;">
                    <?php endif; ?>
                </div>
            </div>
            <!-- end rows -->  
            ...
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2"></div>
                <div class="col-md-10">
                    <?php if(isset($record->photo3) && $record->photo3 != "" && file_exists("../assets/upload/img/".$record->photo3)): ?>
                        <img src="../assets/upload/img/<?php echo $record->photo3; ?>" style="width:100px;">
                    <?php endif; ?>
                </div>
            </div>
            <!-- end rows -->
            ...
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2"></div>
                <div class="col-md-10">
                    <?php if(isset($record->photo4) && $record->photo4 != "" && file_exists("../assets/upload/img/".$record->photo4)): ?>
                        <img src="../assets/upload/img/<?php echo $record->photo4; ?>" style="width:100px;">
                    <?php endif; ?>
                </div>
            </div>
            <!-- end rows -->
            ...
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2"></div>
                <div class="col-md-10">
                    <?php if(isset($record->photo5) && $record->photo5 != "" && file_exists("../assets/upload/img/".$record->photo5)): ?>
                        <img src="../assets/upload/img/<?php echo $record->photo5; ?>" style="width:100px;">
                    <?php endif; ?>
                </div>
            </div>
            <!-- end rows -->
